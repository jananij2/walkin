...
export function ClosetCategoryPicker() {
  const [selectedGroup, setSelectedGroup] = useState(categoryGroups[0].name);
  const [selectedSubcategory, setSelectedSubcategory] = useState(categoryGroups[0].subcategories[0]);
